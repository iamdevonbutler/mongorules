...
class ValueValidator extends Validator {
  constructor() {
    ...
    this.addMethod(self.validateMinLength, minLengthError, 0);
    this.addMethod(self.validateMaxLength, maxLengthError, 0);
