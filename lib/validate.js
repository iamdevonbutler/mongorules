 ...
 */
 ...
 function minLengthError(value, fieldKey, schema) {
   console.log(value);
  return { field: fieldKey, property: 'minLength', value: value, length: value.length, expected: schema.minLength };
 };
...
class ValueValidator extends Validator {
  ...
  constructor() {
    ...
    // Validate type.
    this.addMethod(self.validateType, (value, fieldKey, schema) => {
