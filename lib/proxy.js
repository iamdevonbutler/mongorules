 ...
 * @param {Object} info
 */
var step3Static = function(connectionName, databaseName, db, getModel, staticFunction) {
  return {
 ...
 * @param {Boolean} [validate]
 */
var step2 = function(connectionName, databaseName, collectionName, db, getModel, validate) {
  return {
    get(obj, operation) {
      var handler, model, modelMethod, schema;
 ...
 * @param {Boolean} [validate]
 */
var step1 = function(connectionName, databaseName, db, getModel, validate = true) {
  return {
    get(obj, property) {
