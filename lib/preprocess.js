...
module.exports = {
  ...
  */
  ...
  _preprocessUpdate(payload, schema) {
    // var _document;
    // _document = this._splicePayload(payload);
    // _document = this._preprocessDocument(_document);
    // process document
    // replace documents
  },
   ...
   *
   */
  // _splicePayload(payload) {
  //   var updateFieldOperators = ['$set', '$inc', '$mul', '$rename', '$setOnInsert', '$unset', '$min', '$max', '$currentDate'];
  //   var updateArrayOperators = ['$', '$addToSet', '$pop', '$pullAll', '$pull', '$pushAll', '$push'];
  ...
  //     if (_document) {
  //       splicedDocument = _document;
  //       __.deepSet(payload, documentPath, _document)
  //       return payload;
  //     }
  //     return splicedDocument;
  //   };
  // },
