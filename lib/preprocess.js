...
const valueValidator = new ValueValidator(0);
const arrayValidator = new ArrayValidator(0);
const innerArrayValidator = new InnerArrayValidator(0);
const innerArrayValueValidator = new InnerArrayValueValidator(1);
const objectValidator = new ObjectValidator(0);
const innerArrayObjectValidator = new InnerArrayObjectValidator(1);
