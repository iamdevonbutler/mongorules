...
module.exports = class Schema {
  ...
  getDefaults(set) {
    return this._defaults
      ...
      .map(key => {
        var payloadPath, schemaKey, value, itemInArray, embeddedFieldUpdate,
        fieldSchema, schema, sibling;
        ...
        return new PayloadItem(payloadPath, schemaKey, value, itemInArray, embeddedFieldUpdate, fieldSchema, schema);
      }).filter(Boolean);
  }
