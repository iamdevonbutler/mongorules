...
* @tests integration
*/
self.transformValue = (value, schema, pos) => {
  pos = pos || 0;
  value = self.transformString(value, schema);
  value = self.transformFunction(value, schema, pos);
  return value;
};
...
* @tests unit
*/
self.transformFunction = (value, schema, pos) => {
  pos = pos || 0;
 ...
 * @tests unit
 */
self.transformString = (value, schema) => {
