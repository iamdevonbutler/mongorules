      ...
      if (utils._isType(field, 'array')) {
        ...
        if (childObjectsInArray) {
          ...
          if (field[0][0]) {
            ...
            validationObject.arrayArrayObjects[fieldKey]._schema = this._normalizeSchema(childObjectsInArray);
          ...
          // If array of objects.
            ...
            validationObject.arrayObjects[fieldKey]._schema = this._normalizeSchema(childObjectsInArray);
            // Get fields from _schema._fields and add them to the outermost _fields array.
