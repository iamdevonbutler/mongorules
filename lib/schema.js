    ...
    return _.defaults(schema, {
      _id: {
        validate: function(value) {
          return mongo.ObjectID.isValid(value);
        }
      }
    });
  },
      ...
      if (utils._isType(field, 'array')) {
        ...
        if (childObjectsInArray) {
          ...
          if (field[0][0]) {
            ...
            validationObject.arrayArrayObjects[fieldKey]._schema = this._preprocessSchema(childObjectsInArray);
          ...
          // If array of objects.
            ...
            validationObject.arrayObjects[fieldKey]._schema = this._preprocessSchema(childObjectsInArray);
            // Get fields from _schema._fields and add them to the outermost _fields array.
