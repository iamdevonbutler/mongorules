...
class Api {
  ...
  addDatabase(connectionName, databaseName) {
    ...
    return new Proxy(database, proxyHandler(connectionName, databaseName, this._getModel.bind(this)));
  }
  ...
  getDatabase(connectionName, databaseName) {
    ...
    handler = proxyHandler(connectionName, databaseName, this._getModel.bind(this));
    return new Proxy(database, handler);
  }
